<?php
    ...
    // 실제로는 Database 에 저장하는 작업 수행하고 결과를 응답(response -echo)
    // DB 작업까지 하면 시간이 오래걸리니.. 지금은 그냥 받은 데이터를 그대로 응답해주기
    // echo "$nickname - $email 값으로 회원가입을 했습니다.";

    // ajax 기술이 없을때.. 페이지가 변경되었다는것을 사용자가 인지하지 못하도록 
    // 응답할 때 원래 웹페이지를 그대로 다시 출력
    ...
    <body>
        <!-- 서버에 있는 텍스트 문서를 읽어오는 요청 HTT Request -->
